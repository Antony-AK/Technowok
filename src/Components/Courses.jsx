        ...
        <div className="md:flex md:items-center md:gap-8">
          {/* LEFT CONTENT */} <div className="relative z-20 md:w-2/3">
            <div className="p-10 rounded-3xl bg-[#0d0d0f]/60 backdrop-blur-2xl shadow-[0_0_60px_rgba(255,0,0,0.12)]">
              <h3 className="text-4xl md:text-5xl font-bold tracking-tight mb-4 bg-gradient-to-r from-red-600 to-red-400 text-transparent bg-clip-text"> TECNOWOK SOLUTION </h3>
              ...
              <p className="text-gray-200 text-xl font-semibold max-w-2xl leading-relaxed"> Tecnowok Solution delivers practical, project-based training programs designed to make students job-ready, not just certified. </p>
              ...
              <div className="flex flex-col gap-4">
                ...
                </div> <p className="mt-6 text-gray-400 text-lg italic">We don’t just teach - <span className="text-red-400 font-semibold">we make you job-ready.</span></p> </div>
            </div>
          </div>
