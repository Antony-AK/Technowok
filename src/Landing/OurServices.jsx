...
const SERVICES = [
  {
    ...
    desc: "Custom software, enterprise systems and workflow automation built for speed, security and scalability.",
    img: service1,
    tag: "IT & Automation",
  },
  {
    ...
    desc: "ERP, POS, LMS and ecommerce platforms designed to streamline operations and increase revenue.",
    img: service2,
  ...
  },
  {
    ...
    desc: "SEO, social media, paid ads and growth strategies that drive visibility, leads and conversions.",
    img: service3,
  ...
  },
  {
    ...
    desc: "Brand identity, graphic design, video production and content systems that build trust and recall.",
    img: service4,
  ...
  },
  {
    ...
    desc: "Hire dedicated developers, designers and engineers to scale your team efficiently.",
    img: service5,
    tag: "IT Outsourcing",
  },
  {
    ...
    desc: "24/7 monitoring, updates and optimization to ensure uninterrupted performance.",
    img: service6,
    tag: "IT Support",
  },
];
